...
var _api = _interopRequireDefault(__webpack_require__(/*! ./api */ 16));
__webpack_require__(/*! ./static/common/iconfont.css */ 217);
...
_vue.default.prototype.$service = _api.default;
...
var _default = exports.default = {
  ...
  onLaunch: function onLaunch() {
    ...
    if (accessToken) {
      // 存在登陆状态 刷新登陆状态
      var user_info = uni.getStorageSync('userInfor');
