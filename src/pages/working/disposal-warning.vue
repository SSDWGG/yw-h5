...
export default{
    ...
    onLoad(obj){
        this.sjyjData = uni.getStorageSync('DxyjData')
        this.getDetails(obj)
    },
    methods:{
        getDetails(obj){
            ...
            this.$service.working.getDxyjDetail(params).then(res=>{
                if(res.code == 200) {
        ...
        save(){
            this.details.logs.forEach(e=>{
                if(e.type == 'new') {
                    ...
                    this.$service.working.getDxyjDeal(params).then(res=>{
                        if(res.code == 200) {
